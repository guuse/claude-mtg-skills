...
The deck must beat the **current field**, not just goldfish. Using the current meta (from mtgtop8 via
`scripts/mtgtop8_fetch.py --meta`, falling back to your own knowledge flagged unverified; never scrape
untapped.gg/mtggoldfish, see
